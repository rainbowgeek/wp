 ...
 */
define(['jquery','core/theme-app','core/modules/storage','core/theme-tpl-tags','theme/js/jquery.velocity.min', 'theme/js/comments' ],function($,App,Storage,TplTags,Velocity){
