...
define([
    ...
    App.filter( 'transition-direction', function( transition, current_screen, next_screen ) {
        ...
        if ( current_screen.screen_type == 'page' && next_screen.screen_type == 'comments' ) {
            transition = 'single-to-comments';
        }

        // Comments to age transition
        if ( current_screen.screen_type == 'comments' && next_screen.screen_type == 'page' ) {
            transition = 'comments-to-single';
        }
    ...
    App.action( 'screen-transition', function( $wrapper, $current, $next, current_screen, next_screen, $deferred ) {
        ...
        switch ( direction ) {
            ...
            case 'single-to-comments': // Custom single to comments direction (set in transition-direction filter)
                transition_single_to_comments( $wrapper, $current, $next, current_screen, next_screen, $deferred );
                break;
            case 'comments-to-single': // Custom comments to single direction (set in transition-direction filter)
                transition_comments_to_single( $wrapper, $current, $next, current_screen, next_screen, $deferred );
                break;
            case 'single-to-single': // Custom single to single direction (set in transition-direction filter)
                transition_single_to_single( $wrapper, $current, $next, current_screen, next_screen, $deferred );
                break;
    ...
    transition_single_to_comments = function ( $wrapper, $current, $next, current_screen, next_screen, $deferred ) {
    ...
    transition_comments_to_single = function ( $wrapper, $current, $next, current_screen, next_screen, $deferred ) {
    ...
    transition_single_to_single = function ( $wrapper, $current, $next, current_screen, next_screen, $deferred ) {
    ...
    function setCommentsButton(current_screen) {
        ...
        var commentsLabel = nbComments + " comment"; // Default singular label
    ...
    function shareButtonTapOff(e) {
        ...
        var message = "I've just discovered a great article and I think it may interest you";
